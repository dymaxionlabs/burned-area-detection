...
import numpy as np
import rasterio
from fire.unet.train import TrainConfig, build_model
from fire.unet.utils import load_model
from fire.utils import grouper, resize
    ...
    for mini_group in tqdm(groups):
        ...
        for i, img_path in enumerate(mini_group):
            with rasterio.open(img_path) as src:
                ...
                img_ = resize(img_, (cfg.height, cfg.width))##CHECK
